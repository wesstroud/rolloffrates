...
async def scrape_address(page, address):
    ...
    try:
        ...
        try:
            await page.wait_for_selector("input[placeholder='Enter your address']", timeout=10000)
        ...
        try:
            ...
            print(f"Found Home/Garage Cleanout option for {address}")
        except Exception as e:
            print(f"Could not find Home/Garage Cleanout option: {str(e)}")
        ...
        print(f"Selected Home/Garage Cleanout for {address}")
        ...
        try:
            ...
            print(f"Found Mixed Household Trash option for {address}")
        except Exception as e:
            print(f"Could not find Mixed Household Trash option: {str(e)}")
        ...
        print(f"Selected Mixed Household Trash for {address}")
        ...
        try:
            ...
            print(f"Found Search button for {address}")
        except Exception as e:
        ...
        print(f"Clicked Search button for {address}")
        ...
        try:
            ...
            print(f"Results loaded for {address}")
        except Exception as e:
